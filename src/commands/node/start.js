...
function startMindServer() {
    try {
        // Start the Mind server
        const mindServerCommand = './mind server --data-dir=node --chain genesis.json --libp2p 0.0.0.0:10001 --nat 0.0.0.0 --jsonrpc 0.0.0.0:8545 --seal --block-gas-target 5000000000';
